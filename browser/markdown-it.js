...
var MarkdownRenderer = (() => {
  ...
  // node_modules/markdown-it/node_modules/mdurl/build/index.cjs.js
  var require_index_cjs = __commonJS({
    "node_modules/markdown-it/node_modules/mdurl/build/index.cjs.js"(exports) {
      "use strict";
      var decodeCache = {};
  ...
  // node_modules/markdown-it/node_modules/uc.micro/build/index.cjs.js
  var require_index_cjs2 = __commonJS({
    "node_modules/markdown-it/node_modules/uc.micro/build/index.cjs.js"(exports) {
      "use strict";
      var regex$5 = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/;
  ...
  // node_modules/markdown-it/node_modules/linkify-it/build/index.cjs.js
  var require_index_cjs3 = __commonJS({
    "node_modules/markdown-it/node_modules/linkify-it/build/index.cjs.js"(exports, module) {
      "use strict";
...
`;
  ...
  var default_plugins = [
    ...
    "markdown-it-pangu",
    __require.resolve("./lib/renderer/markdown-it-container"),
    __require.resolve("./lib/renderer/markdown-it-furigana"),
    __require.resolve("./lib/renderer/markdown-it-katex"),
    __require.resolve("./lib/renderer/markdown-it-mermaid"),
    __require.resolve("./lib/renderer/markdown-it-graphviz"),
    __require.resolve("./lib/renderer/markdown-it-prism"),
    __require.resolve("./lib/renderer/markdown-it-chart"),
    __require.resolve("./lib/renderer/markdown-it-spoiler"),
    __require.resolve("./lib/renderer/markdown-it-excerpt")
  ];
  var default_config = {
    render: {
      html: true,
  ...
  function processPlugins(plugins = []) {
    ...
    for (const plugin_config of plugins) {
      ...
      const enable = plugin_config.enable !== false;
  ...
  function applyPlugins(parser, plugins) {
    return plugins.reduce((parser2, plugin_config) => {
      if (!plugin_config.enable) {
        return parser2;
      }
      try {
        let plugin = __require(plugin_config.name);
        ...
        if (plugin_config.options && Object.keys(plugin_config.options).length > 0) {
          return parser2.use(plugin, plugin_config.options);
        } else {
          return parser2.use(plugin);
        }
      } catch (error) {
  ...
  var index_default = markdownRenderer;
